...
class to_do:
    ...
    def add(self, task, category = "general"):
        self.tasks.append({"task": task, "category": category, "completed": False})
...
def main():
    ...
    while True:
        ...
        if dec == '1':
            ...
            category = input("Enter the category (urgent/general/backburner): ")
            todo_list.add(task)
        elif dec == '2':
            todo_list.view()
        elif dec == '3':
